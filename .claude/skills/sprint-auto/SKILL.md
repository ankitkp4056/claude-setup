...
Pick an issue, implement it end-to-end, merge to the work branch, and update the tracker (if available). Runs the full pipeline autonomously without human checkpoints.
...
3. **If GH_TOKEN is available — push and create PR:**
   ...
   ```
   Report: "Branch `$BRANCH` pushed. Proceeding to PR merge."
