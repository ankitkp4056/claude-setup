# Sprint Auto — Full Issue Lifecycle (No Checkpoints)

Pick an issue from your tracker, implement it end-to-end, merge to dev, and update the tracker. Runs the full pipeline autonomously without human checkpoints.
...
Proceed directly to document & ship — no checkpoint.
...
3. Push the branch to origin:
   ...
   ```
4. Report: "Branch `<branch>` pushed. Proceeding to PR merge."

## Stage 9: PR Merge & Cleanup

Invoke the `/pr-merge` skill with the issue number to create the PR, merge to dev, update the tracker, and clean up the worktree:
